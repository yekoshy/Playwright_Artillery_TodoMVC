...
declare const GetScheduledQueryCommand_base: {
    new (input: GetScheduledQueryCommandInput): import("@smithy/smithy-client").CommandImpl<GetScheduledQueryCommandInput, GetScheduledQueryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetScheduledQueryCommandInput): import("@smithy/smithy-client").CommandImpl<GetScheduledQueryCommandInput, GetScheduledQueryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
