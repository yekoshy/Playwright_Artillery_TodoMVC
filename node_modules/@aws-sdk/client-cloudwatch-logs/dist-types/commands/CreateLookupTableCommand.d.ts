...
declare const CreateLookupTableCommand_base: {
    new (input: CreateLookupTableCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLookupTableCommandInput, CreateLookupTableCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateLookupTableCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLookupTableCommandInput, CreateLookupTableCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
