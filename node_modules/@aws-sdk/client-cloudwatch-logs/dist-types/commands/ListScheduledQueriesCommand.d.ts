...
declare const ListScheduledQueriesCommand_base: {
    new (input: ListScheduledQueriesCommandInput): import("@smithy/smithy-client").CommandImpl<ListScheduledQueriesCommandInput, ListScheduledQueriesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListScheduledQueriesCommandInput]): import("@smithy/smithy-client").CommandImpl<ListScheduledQueriesCommandInput, ListScheduledQueriesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
