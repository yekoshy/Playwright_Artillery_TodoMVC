...
declare const UpdateScheduledQueryCommand_base: {
    new (input: UpdateScheduledQueryCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateScheduledQueryCommandInput, UpdateScheduledQueryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateScheduledQueryCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateScheduledQueryCommandInput, UpdateScheduledQueryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
