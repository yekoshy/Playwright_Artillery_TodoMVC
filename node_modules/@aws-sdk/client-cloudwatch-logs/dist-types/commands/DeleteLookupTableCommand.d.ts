...
declare const DeleteLookupTableCommand_base: {
    new (input: DeleteLookupTableCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteLookupTableCommandInput, DeleteLookupTableCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteLookupTableCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteLookupTableCommandInput, DeleteLookupTableCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
