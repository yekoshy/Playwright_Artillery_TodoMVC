...
declare const GetScheduledQueryHistoryCommand_base: {
    new (input: GetScheduledQueryHistoryCommandInput): import("@smithy/smithy-client").CommandImpl<GetScheduledQueryHistoryCommandInput, GetScheduledQueryHistoryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetScheduledQueryHistoryCommandInput): import("@smithy/smithy-client").CommandImpl<GetScheduledQueryHistoryCommandInput, GetScheduledQueryHistoryCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
