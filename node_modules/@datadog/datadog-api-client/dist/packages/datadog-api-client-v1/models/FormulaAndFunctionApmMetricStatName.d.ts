...
export declare const LATENCY_P999 = "latency_p999";
export declare const LATENCY_DISTRIBUTION = "latency_distribution";
export declare const HITS = "hits";
export declare const HITS_PER_SECOND = "hits_per_second";
export declare const TOTAL_TIME = "total_time";
export declare const APDEX = "apdex";
