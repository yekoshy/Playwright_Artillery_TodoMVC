 ...
 */
export declare type ScalarQuery = MetricsScalarQuery | EventsScalarQuery | ApmResourceStatsQuery | ApmMetricsQuery | ApmDependencyStatsQuery | SloQuery | ProcessScalarQuery | ContainerScalarQuery | UnparsedObject;
