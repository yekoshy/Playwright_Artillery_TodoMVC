 ...
 */
export declare type ObservabilityPipelineSplunkHecDestinationTokenStrategy = typeof CUSTOM | typeof FROM_SOURCE | UnparsedObject;
export declare const CUSTOM = "custom";
export declare const FROM_SOURCE = "from_source";
